...
async function main() {
    console.log('🚀 24/7 coffee&roaster ROASTERY HIROSHIMA 이미지 업데이트\n');

    const name = '24/7 coffee&roaster ROASTERY HIROSHIMA';
    const address = '히로시마시 나카구 나카마치';
